...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { btc: @trade.btc, price: @trade.price, trade_type: @trade.trade_type, usd: @trade.usd }
    end
  ...
  test "should update trade" do
    put :update, id: @trade, trade: { btc: @trade.btc, price: @trade.price, trade_type: @trade.trade_type, usd: @trade.usd }
    assert_redirected_to trade_path(assigns(:trade))
  end
